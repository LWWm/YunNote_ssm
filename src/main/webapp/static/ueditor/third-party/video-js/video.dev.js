...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // I tried mulitple ways of setting the iframe src attribute but couldn't find a src that worked well. Tried a real/fake source, in/out of com.domain.
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        // document.com.domain = document.com.domain+'/.';
        // iDoc.com.domain = document.com.domain+'/.';
        ...
        // Again, it's a dynamically generated (same com.domain) iframe, loading an external Flash swf.
