            ...
            <div id="tabcon">
                <div class="box show">
                    ...
                    <form action="${pageContext.request.contextPath}/user/login" method="post" id="loginForm">
                        ...
                        <input type="text" class="user yahei16" id="userName" name="userName" value="${resultInfo.result.userName}"
                               style="width: 248px"/><br/><br/>
                        <input type="password" class="pwd yahei16" id="userPwd" name="userPwd" value="${resultInfo.result.userPwd}"
                               style="width: 248px"/><br/><br/>
