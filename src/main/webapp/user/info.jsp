...
<base href="http://localhost:8080/YunNote_ssm_war_exploded/WEB-INF/">
<div class="col-md-9">
    <div class="data_list">
        ...
        <div class="container-fluid">
            <div class="row" style="padding-top: 20px;">
                <div class="col-md-8">
                    ...
                    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/user/userCenter?updateUserActionName=updateUser" enctype="multipart/form-data">
...
<%--                            <input type="hidden" name="updateUserActionName" value="updateUser">--%>
                ...
                <div class="col-md-4">
                    <img src="user/userHead?imageName=${user.head}" style="width:240px;height:180px">
                </div>
            </div>
        </div>
    </div>
